...
<button type="submit" onClick="javascript:window.location = '?lang=en'">
    English
</button>
<button type="submit" onClick="javascript:window.location = '?lang=ru'">
    Русский
</button>
...
-->
<form:form action="formdata" modelAttribute="loginForm">
    <table>
        <tr>
            <td>
